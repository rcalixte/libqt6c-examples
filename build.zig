...
pub fn build(b: *std.Build) !void {
    ...
    while (try walker.next(b.graph.io)) |entry|
        if (entry.kind == .file and std.mem.eql(u8, entry.basename, "main.c")) {
            ...
            if (is_windows and std.mem.containsAtLeast(u8, parent_dir, 1, "webengine")) continue;
            ...
            var contents = try std.Io.Dir.cwd().readFileAlloc(b.graph.io, qtlibs_path, b.allocator, std.Io.Limit.unlimited);
            ...
            if (syslibs_file) |syslib_file| {
                ...
                contents = try std.Io.Dir.cwd().readFileAlloc(b.graph.io, syslibs_path, b.allocator, std.Io.Limit.unlimited);

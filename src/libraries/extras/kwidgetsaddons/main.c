...
int main(int argc, char* argv[]) {
    ...
    KGuiItem* primary_item = k_guiitem_new7("Hello",
                                            "view-filter",
                                            "This is a tooltip",
                                            "This is a WhatsThis help text.");

    KGuiItem* secondary_item = k_guiitem_new2("Bye");

    int32_t res = k_messagebox_question_two_actions(NULL,
                                                    "Description to tell you to click<br />on <b>either</b> button",
                                                    "Qt 6 KMessageBox Example",
                                                    primary_item, secondary_item, "",
                                                    KMESSAGEBOX_OPTION_NOTIFY);
    ...
    k_guiitem_delete(secondary_item);
    k_guiitem_delete(primary_item);
